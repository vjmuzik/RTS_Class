...
source "$HOME/.espressif/python_env/idf5.5_py3.14_env/bin/activate"
...
export ESP_PYTHON="$HOME/.espressif/python_env/idf5.5_py3.14_env/bin/python"
...
case "$1" in
    ...
    configure)
        ...
        PYTHON_ENV="$HOME/.espressif/python_env/idf5.5_py3.14_env/bin/activate"
